...
class Controller:
    ...
    auto = 0 #se "inicia" la variable auto
...
if __name__ == "__main__":
    ...
    #Se interactua con el publico
    rc = int(input ("Escriba el porcentaje en decimales de rojo para su auto [ej: 0.865]: "))
    gc = int(input ("Escriba el porcentaje en decimales de verde para su auto [ej: 0.76]: "))
    bc = int(input ("Escriba el porcentaje en decimales de verde para su auto [ej: 0.1]: "))
    fon = str(input ("Quiere que sea de día o de noche? [D/N]: "))
    ...
    if fon == "D": 
        fondo = fn.crearfondoDia()
    elif fon == "N":
        fondo = fn.crearfondoNoche()
    else: 
        print("Se escribio algo distinto a D o N, por lo que la computadora quiere que sea de dia")
        fondo = fn.crearfondoDia()
    ...
    controller.auto = at.createCar(rc,gc,bc)
    nave = nv.crearNave()
    ...
    while not glfw.window_should_close(window):
        ...
        controller.auto = at.createCar(rc,gc,bc, controller.light, controller.turbo) 
        ...
        fondo.transform = tr.translate(-vel_f,0,0)
