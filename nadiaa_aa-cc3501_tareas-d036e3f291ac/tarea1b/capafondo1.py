...
def creadpolig(n,color):
    ...
    vertex=[0,0,0,1,1,1,r,0,0,color[0],color[1],color[2]]
...
if __name__ == "__main__":
    ...
    window = glfw.create_window(width, height, "Capa1", None, None)
    ...
    gpuQuad = createQuad([0.9,0.8,0.7])
    gpuCirc = creadpolig(100, [0.9,0.8,0.7])
